  ...
  _createClass(Form, [{
    ...
    value: function submit() {
      ...
      if (this.props.type == 'insert') {
        ...
        var modifier = _utility2.default.docToModifier(data, { keepArrays: this.props.keepArrays });
        ...
        var isValid = this.getSchema().namedContext(this.getValidationOptions().validationContext).validate(_doc);
        if (isValid) {
      ...
      return _react2.default.Children.map(children, function (child) {
        ...
        if (child.type && child.type.recieveMRFData) {
          ...
          options = {
            ...
            errorMessage: _this2.state.errorMessages[fieldName],
