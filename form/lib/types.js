...
var registerType = exports.registerType = function registerType(_ref) {
  ...
  var optionsDefinition = _ref.optionsDefinition;
  var optionsDescription = _ref.optionsDescription;
  var defaultOptions = _ref.defaultOptions;
  var allowedTypes = _ref.allowedTypes;

  Attributes[type] = { name: type, component: component, description: description, optionsDefinition: optionsDefinition, optionsDescription: optionsDescription, allowedTypes: allowedTypes, defaultOptions: defaultOptions };
};
